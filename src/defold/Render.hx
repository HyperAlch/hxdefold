...
extern final class Render {
	...
	**/
	...
	/**
		Sets a render target. Subsequent draw operations will be to the render target 
		until it is replaced by a subsequent call to set_render_target. 
	...
	**/
	...
	static function setRenderTarget(renderarget:RenderTargetOrString, ?options:SetRenderTargetOptions):Void;
...
/**
	Shortcut type that can be either a RenderTarget or String.
**/
typedef RenderTargetOrString = EitherType<RenderTarget, String>;
